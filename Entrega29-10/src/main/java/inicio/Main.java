...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Crea Evento en RAM y lo persiste en la BD
		...
		for (Servicio ser: servicioDAO.buscarServicioPorNombre("limpieza")) {
			System.out.println(ser.getNombre());
		}
		
		System.out.println("Buscar servicios que la categoría sea cocina..."); // -> no hay xd
		for (Servicio ser: servicioDAO.buscarServicioPorNombre("cocina")) {
			System.out.println(ser.getNombre());
		}
